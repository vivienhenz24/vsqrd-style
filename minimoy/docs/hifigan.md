...
Figure 1: The generator upsamples mel-spectrograms up to |ku|subscript𝑘𝑢|k_{u}| times to match the temporal resolution of raw waveforms. A MRF module adds features from |kr|subscript𝑘𝑟|k_{r}| residual blocks of different kernel sizes and dilation rates. Lastly, the n𝑛n-th residual block with kernel size kr​[n]subscript𝑘𝑟delimited-[]𝑛k_{r}[n] and dilation rates Dr​[n]subscript𝐷𝑟delimited-[]𝑛D_{r}[n] in a MRF module is depicted.
...
| ℒA​d​v​(D;G)subscriptℒ𝐴𝑑𝑣𝐷𝐺\displaystyle\mathcal{L}_{Adv}(D;G) | =𝔼(x,s)​[(D​(x)−1)2+(D​(G​(s)))2]absentsubscript𝔼𝑥𝑠delimited-[]superscript𝐷𝑥12superscript𝐷𝐺𝑠2\displaystyle=\mathbb{E}_{(x,s)}\Bigg{[}(D(x)-1)^{2}+(D(G(s)))^{2}\Bigg{]} |  | (1)  
---|---|---|---|---  
| ℒA​d​v​(G;D)subscriptℒ𝐴𝑑𝑣𝐺𝐷\displaystyle\mathcal{L}_{Adv}(G;D) | =𝔼s​[(D​(G​(s))−1)2]absentsubscript𝔼𝑠delimited-[]superscript𝐷𝐺𝑠12\displaystyle=\mathbb{E}_{s}\Bigg{[}(D(G(s))-1)^{2}\Bigg{]} |  | (2)  
...
| ℒM​e​l​(G)subscriptℒ𝑀𝑒𝑙𝐺\displaystyle\mathcal{L}_{Mel}(G) | =𝔼(x,s)​[‖ϕ​(x)−ϕ​(G​(s))‖1]absentsubscript𝔼𝑥𝑠delimited-[]subscriptnormitalic-ϕ𝑥italic-ϕ𝐺𝑠1\displaystyle=\mathbb{E}_{(x,s)}\Bigg{[}||\phi(x)-\phi(G(s))||_{1}\Bigg{]} |  | (3)  
---|---|---|---|---  
...
| ℒF​M​(G;D)subscriptℒ𝐹𝑀𝐺𝐷\displaystyle\mathcal{L}_{FM}(G;D) | =𝔼(x,s)​[∑i=1T1Ni​‖Di​(x)−Di​(G​(s))‖1]absentsubscript𝔼𝑥𝑠delimited-[]superscriptsubscript𝑖1𝑇1subscript𝑁𝑖subscriptnormsuperscript𝐷𝑖𝑥superscript𝐷𝑖𝐺𝑠1\displaystyle=\mathbb{E}_{(x,s)}\Bigg{[}\sum_{i=1}^{T}\frac{1}{N_{i}}||D^{i}(x)-D^{i}(G(s))||_{1}\Bigg{]} |  | (4)  
---|---|---|---|---  
...
| ℒGsubscriptℒ𝐺\displaystyle\mathcal{L}_{G} | =ℒA​d​v​(G;D)+λf​m​ℒF​M​(G;D)+λm​e​l​ℒM​e​l​(G)absentsubscriptℒ𝐴𝑑𝑣𝐺𝐷subscript𝜆𝑓𝑚subscriptℒ𝐹𝑀𝐺𝐷subscript𝜆𝑚𝑒𝑙subscriptℒ𝑀𝑒𝑙𝐺\displaystyle=\mathcal{L}_{Adv}(G;D)+\lambda_{fm}\mathcal{L}_{FM}(G;D)+\lambda_{mel}\mathcal{L}_{Mel}(G) |  | (5)  
---|---|---|---|---  
| ℒDsubscriptℒ𝐷\displaystyle\mathcal{L}_{D} | =ℒA​d​v​(D;G)absentsubscriptℒ𝐴𝑑𝑣𝐷𝐺\displaystyle=\mathcal{L}_{Adv}(D;G) |  | (6)  
  
, where we set λf​m=2subscript𝜆𝑓𝑚2\lambda_{fm}=2 and λm​e​l=45subscript𝜆𝑚𝑒𝑙45\lambda_{mel}=45. Because our discriminator is a set of sub-discriminators of MPD and MSD, Equations 5 and 6 can be converted with respect to the sub-discriminators as

| ℒGsubscriptℒ𝐺\displaystyle\mathcal{L}_{G} | =∑k=1K[ℒA​d​v​(G;Dk)+λf​m​ℒF​M​(G;Dk)]+λm​e​l​ℒM​e​l​(G)absentsuperscriptsubscript𝑘1𝐾delimited-[]subscriptℒ𝐴𝑑𝑣𝐺subscript𝐷𝑘subscript𝜆𝑓𝑚subscriptℒ𝐹𝑀𝐺subscript𝐷𝑘subscript𝜆𝑚𝑒𝑙subscriptℒ𝑀𝑒𝑙𝐺\displaystyle=\sum_{k=1}^{K}\Bigg{[}\mathcal{L}_{Adv}(G;D_{k})+\lambda_{fm}\mathcal{L}_{FM}(G;D_{k})\Bigg{]}+\lambda_{mel}\mathcal{L}_{Mel}(G) |  | (7)  
---|---|---|---|---  
| ℒDsubscriptℒ𝐷\displaystyle\mathcal{L}_{D} | =∑k=1KℒA​d​v​(Dk;G)absentsuperscriptsubscript𝑘1𝐾subscriptℒ𝐴𝑑𝑣subscript𝐷𝑘𝐺\displaystyle=\sum_{k=1}^{K}\mathcal{L}_{Adv}(D_{k};G) |  | (8)  
...
Table 1: Comparison of the MOS and the synthesis speed. Speed of n𝑛n kHz means that the model can generate n×1000𝑛1000n\times 1000 raw audio samples per second. The numbers in () mean the speed compared to real-time. Model |  |  MOS (CI)  
---  
| Speed on CPU  
---  
(kHz)  
...
---  
(M)  
Ground Truth | 4.45 (±plus-or-minus\pm0.06) |  −- |  −- | −-  
WaveNet (MoL) | 4.02 (±plus-or-minus\pm0.08) |  −- | 0.07 | (×0.003absent0.003\times 0.003) | 24.73  
WaveGlow | 3.81 (±plus-or-minus\pm0.08) | 4.72 | (×0.21absent0.21\times 0.21) | 501 | (×22.75absent22.75\times 22.75) | 87.73  
MelGAN | 3.79 (±plus-or-minus\pm0.09) | 145.52 | (×6.59absent6.59\times 6.59) | 14,238 | (×645.73absent645.73\times 645.73) | 4.26  
HiFi-GAN V​1𝑉1V1 |  4.36 (±plus-or-minus\pm0.07) | 31.74 | (×\times1.43) | 3,701 | (×\times167.86) | 13.92  
HiFi-GAN V​2𝑉2V2 | 4.23 (±plus-or-minus\pm0.07) | 214.97 | (×\times9.74) | 16,863 | (×\times764.80) | 0.92  
HiFi-GAN V​3𝑉3V3 | 4.05 (±plus-or-minus\pm0.08) | 296.38 |  (×\times13.44) | 26,169 |  (×\times1,186.80) | 1.46  
  
###  4.2 Ablation Study

We performed an ablation study of MPD, MRF, and mel-spectrogram loss to verify the effect of each HiFi-GAN component on the quality of the synthesized audio. V​3𝑉3V3 that has the smallest expressive power among the three generator variations was used as a generator for the ablation study, and the network parameters were updated up to 500k steps for each configuration.
...
---|---  
Ground Truth | 4.57 (±plus-or-minus\pm0.04)  
Baseline (HiFi-GAN V​3𝑉3V3) | 4.10 (±plus-or-minus\pm0.05)  
w/o MPD | 2.28 (±plus-or-minus\pm0.09)  
w/o MSD | 3.74 (±plus-or-minus\pm0.05)  
w/o MRF | 3.92 (±plus-or-minus\pm0.05)  
w/o Mel-Spectrogram Loss | 3.25 (±plus-or-minus\pm0.05)  
MPD p𝑝p=[2,4,8,16,32] | 3.90 (±plus-or-minus\pm0.05)  
MelGAN | 2.88 (±plus-or-minus\pm0.08)  
MelGAN with MPD | 3.35 (±plus-or-minus\pm0.07)  
...
---|---  
Ground Truth | 3.79 (±plus-or-minus\pm0.07)  
WaveNet (MoL) | 3.52 (±plus-or-minus\pm0.08)  
WaveGlow | 3.52 (±plus-or-minus\pm0.08)  
MelGAN | 3.50 (±plus-or-minus\pm0.08)  
HiFi-GAN V​1𝑉1V1 |  3.77 (±plus-or-minus\pm0.07)  
HiFi-GAN V​2𝑉2V2 | 3.69 (±plus-or-minus\pm0.07)  
HiFi-GAN V​3𝑉3V3 | 3.61 (±plus-or-minus\pm0.07)  
  
Table 4: Quality comparison for end-to-end speech synthesis. Model |  MOS (CI)  
---|---  
Ground Truth | 4.23 (±plus-or-minus\pm0.07)  
WaveGlow (w/o fine-tuning) | 3.69 (±plus-or-minus\pm0.08)  
HiFi-GAN V​1𝑉1V1 (w/o fine-tuning) | 3.91 (±plus-or-minus\pm0.08)  
HiFi-GAN V​2𝑉2V2 (w/o fine-tuning) | 3.88 (±plus-or-minus\pm0.08)  
HiFi-GAN V​3𝑉3V3 (w/o fine-tuning) | 3.89 (±plus-or-minus\pm0.08)  
WaveGlow (find-tuned) | 3.66 (±plus-or-minus\pm0.08)  
HiFi-GAN V​1𝑉1V1 (find-tuned) |  4.18 (±plus-or-minus\pm0.08)  
HiFi-GAN V​2𝑉2V2 (find-tuned) | 4.12 (±plus-or-minus\pm0.07)  
HiFi-GAN V​3𝑉3V3 (find-tuned) | 4.02 (±plus-or-minus\pm0.08)  
...
Figure 4: (a) The generator. (b) The sub-discriminator of MPD with period p𝑝p. Table 5: Hyper-parameters of three generator V​1𝑉1V1, V​2𝑉2V2, and V​3𝑉3V3. | Hyper-Parameters  
---|---  
Model | husubscriptℎ𝑢h_{u} | kusubscript𝑘𝑢k_{u} | krsubscript𝑘𝑟k_{r} |  Drsubscript𝐷𝑟D_{r}  
V​1𝑉1V1 | 512 | [16, 16, 4, 4] | [3, 7, 11] | [[1, 1], [3, 1], [5, 1]] ×\times3  
V​2𝑉2V2 | 128 | [16, 16, 4, 4] | [3, 7, 11] | [[1, 1], [3, 1], [5, 1]] ×\times3  
V​3𝑉3V3 | 256 | [16, 16, 8] | [3, 5, 7] | [[1], [2]], [[2], [6]], [[3], [12]]  
...
on arXiv](https://arxiv.org/abs/2010.05646)[►](/html/2010.05647)
